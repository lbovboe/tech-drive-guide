  ...
  return (
    <div>
      ...
      <StepCard number={2} title="Create the scheduled task">
        ...
        <PromptBlock>{`Create a scheduled task. Every morning at 11:30am, search the web for the top three most important technology news stories published within the past 3 days.
